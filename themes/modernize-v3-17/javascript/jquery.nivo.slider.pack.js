                ...
                if(nivoCaption.css('display') == 'block'){
                    nivoCaption.stop().fadeTo(settings.animSpeed, 0, function(){
						...
						if( typeof(Cufon) != 'undefined' ){
							var gdl_font_fam = $(this).find('.gdl-title').css('font-family');
							gdl_font_fam = gdl_font_fam.replace(/'/g,"");
							if( Cufon.hasFont( gdl_font_fam ) ){
								Cufon.replace($(this).find('.gdl-title'), {fontFamily: gdl_font_fam});		
							}
						}
					...
					/*Using Cufon in title*/	
					if( typeof(Cufon) != 'undefined' ){
						var gdl_font_fam = nivoCaption.find('.gdl-title').css('font-family');
						gdl_font_fam = gdl_font_fam.replace(/'/g,"");
						if( Cufon.hasFont( gdl_font_fam ) ){
							Cufon.replace(nivoCaption.find('.gdl-title'), {fontFamily: gdl_font_fam});		
						}
					}					
...
jQuery(window).load(function() {
	...
	NIVO.directionNavHide = (NIVO.directionNavHide == 'enable')? true: false;
