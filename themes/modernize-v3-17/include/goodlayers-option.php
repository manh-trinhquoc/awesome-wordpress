	...
	*/
	...
	$goodlayers_menu = array(			
		__('General', 'gdl_back_office') => array(
			...
			__('Additional Css', 'gdl_back_office')=>'gdl_panel_additional_css'),
		...
		__('Overall Elements', 'gdl_back_office') => array(
			...
			__('Top Right Area', 'gdl_back_office')=>'gdl_panel_top_right_area',
		...
		__('Elements Color', 'gdl_back_office') => array(
			...
			__('Header / Top Search', 'gdl_back_office')=>'gdl_panel_top_search',
			__('Body', 'gdl_back_office')=>'gdl_panel_body',
			__('Footer', 'gdl_back_office')=>'gdl_panel_footer',
			__('Slider / Personnel', 'gdl_back_office')=>'gdl_panel_slider',
			...
			__('Import/Export Color', 'gdl_back_office')=>'gdl_panel_load_default_color'),
		...
		__('Slider Setting', 'gdl_back_office') => array(
			__('Layer Slider', 'gdl_back_office')=>'gdl_panel_layer_slider',
	...
	$goodlayers_element = array(
		...
		'gdl_panel_page_style' => array(
			...
			__('BOXED LAYOUT', 'gdl_back_office')=>array(
				'type'=>'radioenabled',
				'name'=>THEME_SHORT_NAME.'_enable_boxed_layout',
				'description'=>'Container color/shadow will be disabled out in this mode.'
			),			
			...
			__('SEARCH/ARCHIVE ITEM SIZE', 'gdl_back_office')=>array(
				...
				'options'=>array('1/4 Blog Grid', '1/3 Blog Grid', '1/2 Blog Grid', '1/1 Full Thumbnail', '1/1 Medium Thumbnail')
			),	
		...
		'gdl_panel_additional_css' => array(
		...
		'gdl_panel_font' => array(
			__('HEADER FONT', 'gdl_back_office')=>array('type'=>'font-combobox','name'=>THEME_SHORT_NAME.'_header_font', 'default'=>'- Droid Serif',
			...
			__('STUNNING TEXT FONT', 'gdl_back_office')=>array('type'=>'font-combobox','name'=>THEME_SHORT_NAME.'_stunning_text_font', 'default'=>'- Museo Sans',
		...
		'gdl_panel_logo' => array( 
			...
			__('LOGO TOP MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_logo_top_margin','default'=>'35',
			...
			__('LOGO BOTTOM MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_logo_bottom_margin','default'=>'26',
		...
		'gdl_panel_top_navigation' => array( 
			...
			__('TOP NAVIGATION RIGHT TEXT', 'gdl_back_office')=>array('type'=>'textarea','name'=>THEME_SHORT_NAME.'_top_navigation_right_text'), 
		),
		...
		'gdl_panel_top_right_area'=>array(
			__('TEXT ABOVE ICON', 'gdl_back_office')=>array('type'=>'textarea','name'=>THEME_SHORT_NAME.'_social_wrapper_text', 'default'=>'',
				'description'=>'This is the text that will appear above the social icon( top right side ). Leave it blank to remove it.'),		
		),

		'gdl_panel_social_network' => array( 
			__('MARGIN TOP', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_social_wrapper_margin', 'default'=>'33',
				'description'=>'Set the top sapce over the social icons( top right side ). The minimun value is 1'),	
		...
		'gdl_panel_navigation' => array(
			__('TOP NAVIGATION BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_navigation_background','default'=>'#494949'),
			__('TOP NAVIGATION BOTTOM BAR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_navigation_bottom_bar','default'=>'#e77927',
				'description'=>'This is a little bar color below the top navigation, you can change it as you want.'),
			__('TOP NAVIGATION TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_navigation_text','default'=>'#e7e7e7',),		
			__('MAIN NAVIGATION GRADIENT', 'gdl_back_office')=>array('type'=>'radioenabled','name'=>THEME_SHORT_NAME.'_main_navigation_gradient'),
			__('MAIN NAVIGATION BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_background','default'=>'#fdfdfd'),
			__('MAIN NAVIGATION BORDER LEFT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_border_left','default'=>'#ffffff',
				'description'=>'This is 1 pixel verticle divider left side between each main menu. Normally it is darker than the right border.'),
			__('MAIN NAVIGATION BORDER RIGHT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_border_right','default'=>'#dbdbdb',
				'description'=>'This is 1 pixel verticle divider right side between each main menu. Normally it is lighter than the left border.'),
			__('MAIN NAVIGATION BORDER TOP/BOTTOM', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_border_top_bottom','default'=>'#ececec',
				'description'=>'This color effects the top border, buttom border and submenu border of the main navigation.'),
			__('MAIN NAVIGATION TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_text','default'=>'#7a7a7a',
			...
			__('MAIN NAVIGATION BOTTOM SHADOW', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_bottom_shadow','default'=>'#f5f5f5',
				'description'=>'This is the bottom shadow color of the main navigation. You can see it if the top slider does not exists.'),		
			...
			__('SUB NAVIGATION TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_text','default'=>'#7a7a7a'),
		...
		'gdl_panel_top_search' => array(
			__('HEADER BACKGROUND COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_header_background_color','default'=>'#ffffff'),
			__('SEARCH BOX BACKGROUND COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_search_box_background','default'=>'#efefef'),
			__('SEARCH BOX SHADOW COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_search_box_shadow','default'=>'#dddddd',
				'description'=>'This is the inner shadow color of search text box. Change it to match with background color.'),
			__('SEARCH BOX TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_search_box_text','default'=>'#333333'),
		),
		...
		'gdl_panel_body' => array(	
			...
			__('CONTAINER SHADOW', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_container_shadow','default'=>'#bbbbbb'),
		...
		'gdl_panel_footer' => array(	
			...
			__('FOOTER TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_title_color','default'=>'#ececec'),	
			__('FOOTER CONTENT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_content_color','default'=>'#999999'),	
			...
			__('FOOTER BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_background','default'=>'#313131'),
			__('FOOTER TOP BAR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_top_bar','default'=>'#cfcfcf',
				'description'=>'This is the little bar color over the footer. Change it to match with the theme style.'),
			__('FOOTER DIVIDER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_divider_color', 'default'=>'#3b3b3b'),
			...
			__('FOOTER INPUT BOX BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_input_background', 'default'=>'#383838'),
			__('FOOTER INPUT BOX BORDER', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_input_border', 'default'=>'#434343'),
			...
			__('FOOTER BUTTON TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_button_text', 'default'=>'#7a7a7a'),
			__('FOOTER FRAME BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_frame_background', 'default'=>'#292929',
				'description' =>'Frame is the elements that wrap post/portfolio(widget) thumbnail.'),
			__('FOOTER FRAME BORDER', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_frame_border', 'default'=>'#3b3b3b'),
		...
		'gdl_panel_slider' => array(
			__('SLIDER TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_slider_title_color','default'=>'#ef7f2c'),
			...
			__('TOP SLIDER BOTTOM LINE', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_full_slider_bottom_line','default'=>'#ebebeb',
				'description'=>'Only top slider will have little bar below the slider. You can change it to any color you prefer.'),	
			__('LAYER SLIDER NAV BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_layer_slider_nav_background','default'=>'#ef7f2c'),
			__('PERSONNAL BACKGROUND', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_personnal_background', 'default'=>'#f7f7f7'),
			__('PERSONNAL POSITION TEXT', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_personnal_position_text', 'default'=>'#9d9d9d'),
			__('PERSONNAL TITLE', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_personnal_title', 'default'=>'#353535'),
			__('PERSONNAL THUMBNAIL BORDER', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_personnal_thumbnail_border', 'default'=>'#ef7f2c'),
			__('PERSONNAL CONTENT', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_personnal_content', 'default'=>'#838383'),			
			__('PERSONNAL WIDGET INFO', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_personnal_widget_info', 'default'=>'#4a4a4a'),				
		),
		...
		'gdl_panel_blog_port' => array(
			...
			__('BLOG INFO COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_info_color','default'=>'#797979',
				'description'=>"This is the blog informateion color. It's include the color of blog date, blog comments number and blog author."),
			__('BLOG (WIDGET STYLE) TITLE', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_widget_title_color','default'=>'#ef7f2c'),
			__('BLOG/PORT FRAME COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_port_frame_color','default'=>'#f0f0f0'),
			__('BLOG/PORT FRAME BORDER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_port_frame_border','default'=>'#ffffff'),
		...
		'gdl_panel_stunning_text' => array(
			...
			__('STUNNING TEXT BUTTON BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_stunning_text_button_background','default'=>'#ef7f2c',
		...
		'gdl_panel_additional_elements' => array(
			...
			__('COLUMN SERVICE TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_column_service_title_color','default'=>'#ef7f2c',),
		...
		'gdl_panel_load_default_color' => array(
			__('LOAD DEFAULT COLOR','gdl_back_office')=>array('type'=>'button','text'=>'Load Default','id'=>'gdl_load_default_color_button',
		...
		'gdl_panel_additional_elements_translator' => array(
			...
			__('404 CONTENT (404 PAGE)', 'gdl_back_office')=>array('type'=>'textarea','name'=>THEME_SHORT_NAME.'_404_content','default'=>"The page or document you are looking for doesn't seem to exist."),
		...
		'gdl_panel_nivo_slider' => array(
			...
			__('PAUSE TIME', 'gdl_back_office')=>array('type'=>'inputtext','oldname'=>'pauseTime','name'=>THEME_SHORT_NAME.'_nivo_slider_pause_time','default'=>'3000',
		...
		'gdl_panel_anything_slider' => array(
			...
			__('ANIMATION SPEED', 'gdl_back_office')=>array('type'=>'inputtext','oldname'=>'animationTime','name'=>THEME_SHORT_NAME.'_anything_slider_animation_speed','default'=>'600',
				'description'=>'This is the animation speed during the change of each slide.'),
			__('PAUSE TIME', 'gdl_back_office')=>array('type'=>'inputtext','oldname'=>'delay','name'=>THEME_SHORT_NAME.'_anything_slider_pause_time','default'=>'3000',
				'description'=>'This option is the pause time of each slider.'),
		)
