<?php
	...
	*/
	...
	function get_youtube($url, $width = 640, $height = 480, $type = 'youtube'){
		...
		$autoplay = "";
		if( strpos($url, 'autoplay') > 0 ) $autoplay = "&autoplay=1";
		...
		*/
		...
		<iframe src="http://www.youtube.com/embed/<?php echo $id[1]; ?>?wmode=transparent<?php echo $autoplay; ?>&rel=0" width="<?php echo $width; ?>" height="<?php echo $height; ?>" ></iframe>
	...
	function print_nivo_slider($slider_xml, $size='980x360'){
		...
		for( $i=0; $i<$caption_num; $i++ ){
			...
			echo '<div class="gdl-nivo-caption-wrapper">';
