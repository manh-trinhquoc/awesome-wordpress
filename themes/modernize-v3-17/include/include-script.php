<?php
	...
	*/ 
	...
	function register_meta_script(){
		...
		}else if( $post_type == 'testimonial' || $post_type == 'personnel' ){
	...
	*/ 
	...
	function register_non_admin_styles(){
		...
		wp_enqueue_style('fancybox',GOODLAYERS_PATH.'/javascript/fancybox/jquery.fancybox.css');
		wp_enqueue_style('fancybox-thumb',GOODLAYERS_PATH.'/javascript/fancybox/jquery.fancybox-thumbs.css');
	...
	function register_non_admin_scripts(){
		...
		wp_register_script('fancybox', GOODLAYERS_PATH.'/javascript/fancybox/jquery.fancybox.pack.js', false, '1.0', true);
		wp_enqueue_script('fancybox');	
		
		wp_deregister_script('fancybox-media');
		wp_register_script('fancybox-media', GOODLAYERS_PATH.'/javascript/fancybox/jquery.fancybox-media.js', false, '1.0', true);
		wp_enqueue_script('fancybox-media');	

		wp_deregister_script('fancybox-thumbs');
		wp_register_script('fancybox-thumbs', GOODLAYERS_PATH.'/javascript/fancybox/jquery.fancybox-thumbs.js', false, '1.0', true);
