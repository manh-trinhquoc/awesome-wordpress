<?php 
	...
	*/
			...
			'name'=>array(
				...
				'Blog'=>array(
					...
					'item-size'=>array(
						...
						'options'=>array('0'=>'Widget Style', 
							'1'=>'1/4 Blog Grid', '2'=>'1/3 Blog Grid', '3'=>'1/2 Blog Grid',
							'4'=>'1/1 Medium Thumbnail', '5'=>'1/1 Full Thumbnail',),
						'type'=>'combobox',
				...
				'Gallery' =>array(
					...
					'gallery-caption'=> array(
						'title'=> 'ENABLE GALLERY CAPTION',
						'name'=> 'page-option-item-gallery-caption',
						'type'=> 'combobox',
						'options'=> array('No', 'Yes'),
						'hr'=>'none'
					),							
				...
				'Personnel'=>array(
					'item-size'=>array(
						...
						'name'=>'page-option-item-personnel-size',
						'options'=>array('0'=>'1/4', '1'=>'1/3', '2'=>'1/2', '3'=>'1/1'),
						'type'=>'combobox',
						'description'=>'This is the actual size of the personnel thumbnail. Outside size is the size of wrapper. If you choose the wrapper size to be 1/1 and item size to be 1/4, you will get up to 4 personnel thumbnails in one row.'),
					'category'=>array(
						'title'=>'CHOOSE CATEGORY',
						'name'=>'page-option-item-personnel-category',
						'options'=>array(),
						'type'=>'combobox',
						'description'=>'Choose the personnel category you want the item to be fetched.'),	
					'num-fetch'=>array(					
						'title'=> 'PERSONNEL NUM FETCH',
						'name'=> 'page-option-item-personnel-num-fetch',
						'type'=> 'inputtext',
						'default'=> 9,
						'hr'=> 'none',
						'description'=> 'This is the number of personnel thumbnail you want to fetch in one page.'),						
				),
	...
	function add_page_option_element(){
		...
		$page_meta_boxes['Page Item']['name']['Personnel']['category']['options'] = get_category_list( 'personnel-category' );
