          ...
          <ul style="margin-bottom: 15px;">
            ...
            <li>
             ...
             <li>
                ...
                <input class="med" style="width: 5em;" type='text' name="subscription[setup_fee]" id="subscription-setup_fee" value='<?php echo $data['subscription']->id > 0 ? Cart66Common::currency($data['subscription']->setupFee, true, false, false) : ''; ?>' />
            ...
            <li>
              ...
              <?php echo Cart66Common::currencySymbol('before'); ?>
              <input class="med" style="width: 5em;" type="text" name="subscription[price]" id="subscription-price" value="<?php echo $data['subscription']->id > 0 ? Cart66Common::currency($data['subscription']->price, true, false, false) : ''; ?>" />
              <?php echo Cart66Common::currencySymbol('after'); ?>
            </li>
            <li>
