...
<div id="shipping_tabs" class="wrap">
  <div class="cart66Tabbed">
      ...
      <form action="" method="post">
        ...
        <span class="currency" style="display:none;"><?php echo Cart66Common::currencySymbol('before'); ?></span>
        <input type="text" name="rate_tweak_factor" style="width: 5em;" />
        <span class="currency" style="display:none;"><?php echo Cart66Common::currencySymbol('after'); ?></span>
        <span class="percentSign" style="display:none;">%</span>
