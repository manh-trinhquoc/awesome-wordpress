...
if(!$test) {
            ...
            <td>
              ...
              <?php if(Cart66Setting::getValue('receipt_message_intro')): ?>
                <table width="562" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="font-family: Arial, Verdana, sans-serif; padding: 10px 25px 0px 15px; font-size: 14px; color:#333;">
                  <tr>
                    <td>
                      <?php echo Cart66Setting::getValue('receipt_html_email'); ?>
                    </td>
                  </tr>
                </table>
              <?php endif; ?>
  ...
  ?>
    ...
    <head>
      <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
      <title><?php _e('TEST - Email Receipt', 'cart66'); ?></title>
      <style type="text/css">
        span.yshortcuts { color:#000; background-color:none; border:none;}
        span.yshortcuts:hover,
        span.yshortcuts:active,
    ...
    <body style="font-family: Arial, Verdana, sans-serif;background-color:#fff;">
      <div id="body_style">
        <!-- Start Main Table -->
        <table width="100%" height="100%"  cellpadding="0" cellspacing="0" style="padding: 20px 0px 20px 0px" bgcolor="#ffffff">
          <tr align="center">
