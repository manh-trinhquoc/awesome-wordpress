...
class Cart66MailChimp{
  ...
  function MCAPI($apikey="", $secure=false) {
      ...
      $this->api_key = (empty($apikey)) ? Cart66Setting::getValue('mailchimp_apikey') : $apikey;
  }
  ...
  */
  ...
  public function getCampaigns(){
    ...
    $retval = $MailChimp->campaigns();
    $output = "";
    
    if ($api->errorCode){
    	$output = "Unable to Pull list of Campaign!";
    	$output .= "\n\tCode=".$api->errorCode;
