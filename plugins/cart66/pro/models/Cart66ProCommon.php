...
class Cart66ProCommon {
  ...
  public static function getUspsServices() {
    $usaServices = array(
      ...
      'USPS Media Mail' => 'Media Mail Parcel',
      'USPS Library Mail' => 'Library Mail Parcel',
  ...
  public static function getCaPostIntlServices() {
    $internationalServices = array(
      ...
      'Canada Post Tracked Packet USA' => 'Tracked Packet - USA',
      ...
      'Canada Post Tracked Packet International' => 'Tracked Packet - International',
